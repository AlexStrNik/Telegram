...
class ProfileActivitySearchAdapter extends RecyclerListView.SelectionAdapter {
    ...
    SearchResult[] onCreateSearchArray() {
        return new SearchResult[]{
                new SearchResult(500, getString(R.string.EditName), 0, () -> profileActivity.presentFragment(new ChangeNameActivity(profileActivity.resourcesProvider))),
                ...
                new SearchResult(504, getString(R.string.AddPhoto), 0, profileActivity::onWriteButtonClick),
                ...
                MessagesController.getInstance(profileActivity.getCurrentAccount()).getTranslateController().isContextTranslateEnabled() ? new SearchResult(406, getString(R.string.DoNotTranslate), getString(R.string.Language), R.drawable.msg2_language, () -> profileActivity.presentFragment(new LanguageSelectActivity())) : null,
    ...
    void loadFaqWebPage() {
        ...
        profileActivity.getConnectionsManager().sendRequest(req2, (response2, error2) -> {
            if (response2 instanceof TLRPC.TL_messages_webPage) {
                ...
                MessagesController.getInstance(profileActivity.getCurrentAccount()).putUsers(res.users, false);
                MessagesController.getInstance(profileActivity.getCurrentAccount()).putChats(res.chats, false);
    ...
    public void search(String text) {
        ...
        if (TextUtils.isEmpty(text)) {
            ...
            resultNames.clear();
            profileActivity.emptyView.stickerView.getImageReceiver().startAnimation();
            profileActivity.emptyView.title.setText(getString(R.string.SettingsNoRecent));
            notifyDataSetChanged();
            return;
        }
        Utilities.searchQueue.postRunnable(searchRunnable = () -> {
            ...
            AndroidUtilities.runOnUIThread(() -> {
                ...
                if (!searchWas) {
                    profileActivity.emptyView.stickerView.getImageReceiver().startAnimation();
                    profileActivity.emptyView.title.setText(LocaleController.getString(R.string.SettingsNoResults));
                }
                searchWas = true;

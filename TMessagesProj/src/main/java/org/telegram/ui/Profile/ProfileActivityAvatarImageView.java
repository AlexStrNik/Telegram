...
public class ProfileActivityAvatarImageView extends BackupImageView {
    ...
    public ProfileActivityAvatarImageView(Context context) {
        super(context);
    ...
    public static Property<ProfileActivityAvatarImageView, Float> CROSSFADE_PROGRESS = new AnimationProperties.FloatProperty<ProfileActivityAvatarImageView>("crossfadeProgress") {
        @Override
        public void setValue(ProfileActivityAvatarImageView object, float value) {
            object.setCrossfadeProgress(value);
        }

        @Override
        public Float get(ProfileActivityAvatarImageView object) {

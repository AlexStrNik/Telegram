...
public class ProfileGalleryView extends CircularViewPager implements NotificationCenter.NotificationCenterDelegate {
    ...
    public ProfileGalleryView(Context context, long dialogId, ActionBar parentActionBar, RecyclerListView parentListView, ProfileActivityAvatarImageView parentAvatarImageView, int parentClassGuid, Callback callback) {
        super(context);
    ...
    public class ViewPagerAdapter extends Adapter {
        ...
        public ViewPagerAdapter(Context context, ProfileActivityAvatarImageView parentAvatarImageView, ActionBar parentActionBar) {
